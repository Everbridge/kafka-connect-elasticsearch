...
public class ActionableRecord {
  ...
  public ActionableRecord(Key key, String routing, String payload, Long version,
  ...
  public BulkableAction toActionRequest() {
    BulkableAction action = null;
    if (actionType == ActionType.Index) {
